...
2. Boot the PYNQ-Z2 with this image 
   ...
   You will need to have terminal emulator software installed on your computer. 
   **Tera Term** is one application that can be used, and is available for free on Windows. 
